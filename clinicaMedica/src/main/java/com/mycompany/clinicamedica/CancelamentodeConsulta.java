 ...
 * @author Gabri
 */
public class CancelamentodeConsulta extends javax.swing.JFrame {

    /**
     * Creates new form CancelamentodeConsulta
     */
    public CancelamentodeConsulta() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CancelamentodeConsulta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CancelamentodeConsulta().setVisible(true);
            }
        });
    }
